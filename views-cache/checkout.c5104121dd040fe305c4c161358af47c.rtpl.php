                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="woocommerce-billing-fields">
                                        ...
                                        <div id="order_review" style="position: relative;">
                                            ...
                                            <p id="opcao_1" class="form-row form-row-first" data-o_class="form-row form-row-first">
                                                <input type="radio" id="method-boleto" name="payment-method" value="1" style="float:left; margin: 30px;" checked="checked">
                                                <label class="" for="method-boleto"><img style="height:64px;" src="/res/site/img/logo-boleto.png"></label>
                                            </p>
                                            <p id="opcao_2" class="form-row form-row-first" data-o_class="form-row form-row-first">
                                                <input type="radio" id="method-pagseguro" name="payment-method" value="2" style="float:left; margin: 30px;">
                                                <label class="" for="method-pagseguro"><img style="height:64px;" src="/res/site/img/logo-pagseguro.png"></label>
                                            </p>
                                            <p id="opcao_3" class="form-row form-row-first" data-o_class="form-row form-row-first">
                                                <input type="radio" id="method-paypal" name="payment-method" value="3" style="float:left; margin: 30px;">
