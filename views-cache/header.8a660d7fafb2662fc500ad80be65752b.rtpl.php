...
<head>
  ...
  <title>SystecCG - Administrador | Iniciado</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="/res/admin/index2.html" class="logo">
      ...
      <span class="logo-lg"><b>SystecCG</b>-Adm</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown messages-menu">
            ...
            <ul class="dropdown-menu">
              <li class="header">Você tem n mensagens</li>
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <!-- User Image -->
                        <img src="/res/admin/dist/img/user_Humberto.jpg" class="img-circle" alt="User Image">
                      </div>
          ...
          <li class="dropdown notifications-menu">
            ...
            <ul class="dropdown-menu">
              <li class="header">Você tem n notificações</li>
              <li>
          ...
          <li class="dropdown tasks-menu">
            ...
            <ul class="dropdown-menu">
              <li class="header">Você tem n tarefas</li>
              <li>
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="/res/admin/dist/img/user_Humberto.jpg" class="user-image" alt="User Image">
              <!-- hidden-xs hides the username on small devices so only the image appears. -->
              <span class="hidden-xs">Carlos H B Toscano</span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  Carlos Humberto Brasileiro Toscano - Desenvolvedor Web
