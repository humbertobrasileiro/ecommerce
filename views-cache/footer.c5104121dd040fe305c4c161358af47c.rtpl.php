<?php if(!class_exists('Rain\Tpl')){exit;}?>    <div class="footer-top-area">
    ...
    <div class="footer-bottom-area">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="copyright">
                        <p>&copy; 2019 SystecCG Software. <a href="http://www.systeccgcommerce.com.br" target="_blank">systeccgcommerce.com.br</a></p>
                    </div>
                </div>
    ...
    <script src="/res/site/js/handlebars-v4.1.2.js"></script>
